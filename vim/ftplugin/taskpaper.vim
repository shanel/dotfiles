...
map <buffer> <silent> <LocalLeader>pd <Plug>ToggleDone
map <buffer> <silent> <LocalLeader>pc <Plug>ShowContext
map <buffer> <silent> <LocalLeader>pa <Plug>ShowAll
map <buffer> <silent> <LocalLeader>pp <Plug>FoldAllProjects
